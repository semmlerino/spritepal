#!/usr/bin/env python3
"""
Undo/Redo manager for the pixel editor.
...
class UndoManager:
    ...
    def execute_command(self, command: UndoCommand, model: ImageModel) -> None:
    ...
    def undo(self, model: ImageModel) -> bool:
    ...
    def redo(self, model: ImageModel) -> bool:
