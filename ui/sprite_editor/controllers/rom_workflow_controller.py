...
class ROMWorkflowController(QObject):
    ...
    def revert_to_original(self) -> None:
        ...
        # Clear undo history before loading fresh data (prevents inconsistent state)
        ...
        try:
            ...
            if dialog.exec():
                ...
                if result:
                    ...
                    # 5. Apply extracted palette if present (from Extract Palette button)
                    # MUST be after open_in_editor() which loads ROM/library palettes
