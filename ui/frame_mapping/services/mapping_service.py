...
class MappingService(QObject):
    ...
    # ─── No-History Methods (for command execution) ─────────────────────────────

    def create_mapping_no_history(
        self,
        project: FrameMappingProject,
        ai_frame_id: str,
        game_frame_id: str,
    ) -> None:
        """Create mapping without undo history (for command execution).
        ...
        Args:
            ...
            game_frame_id: ID of the game frame
        """
        project.create_mapping(ai_frame_id, game_frame_id)

    def remove_mapping_no_history(
        self,
        project: FrameMappingProject,
        ai_frame_id: str,
    ) -> bool:
        """Remove mapping without undo history (for command execution).
        ...
        """
        return project.remove_mapping_for_ai_frame(ai_frame_id)

    def set_mapping_status_no_history(
        self,
        project: FrameMappingProject,
        ai_frame_id: str,
        status: str,
    ) -> bool:
        """Set mapping status without undo history (for command execution).
