...
from .validation_mixins import ExtractionValidationMixin, InjectionValidationMixin
...
class CoreOperationsManager(
    ExtractionValidationMixin, InjectionValidationMixin, BaseManager
):
    """
    ...
    Validation methods are provided by ExtractionValidationMixin and
    InjectionValidationMixin to share logic with deprecated managers.
    """
