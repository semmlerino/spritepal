...
class SafeAnimation:
    ...
    def __init__(self, target: QObject | None = None, property_name: bytes | None = None):
        ...
        self._finished_callbacks: list[Callable[..., object]] = []
        self._value_changed_callbacks: list[Callable[..., object]] = []
    ...
    def setStartValue(self, value: object) -> None:
    ...
    class _MockSignal:
        ...
        def __init__(self, callbacks: list[Callable[..., object]]):
