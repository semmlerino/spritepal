...
def test_ready_for_inject_hidden_in_rom_mode(qtbot):
    ...
    class MockController(QObject):
        ...
        def handle_pixel_press(self, x, y): pass
        def handle_pixel_move(self, x, y): pass
        def handle_pixel_release(self, x, y): pass
        def set_tool(self, tool): pass
        def set_selected_color(self, color): pass
        def handle_palette_source_changed(self, source, index): pass
        def handle_load_palette(self): pass
        def handle_save_palette(self): pass
        def handle_edit_color(self): pass
