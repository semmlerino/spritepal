...
class TestLayoutResponsiveness:
    ...
    def test_layout_collapse_restore(self, mock_dependencies):
        ...
        coordinator = UICoordinator(
            deps["sprite_preview"], deps["palette_preview"], deps["main_window"],
            deps["extraction_panel"], deps["output_settings_manager"], deps["session_manager"],
            deps["extraction_tabs"], deps["rom_extraction_panel"], deps["toolbar_manager"],
    ...
    def test_canvas_responsiveness(self, qt_app):
        # ... existing test ...
        with patch('ui.sprite_editor.views.tabs.edit_tab.ToolPanel', MockPanel), \
