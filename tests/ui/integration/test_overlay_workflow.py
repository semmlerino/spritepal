...
# =============================================================================
# PIXEL CANVAS OVERLAY TESTS
# Source: tests/ui/test_pixel_canvas_overlay.py
# =============================================================================


class TestPixelCanvasOverlay:
    """Tests for PixelCanvas overlay rendering and state.

    Source: tests/ui/test_pixel_canvas_overlay.py
    """

    @pytest.fixture
    def pixel_canvas(self, qtbot):
        """Create a PixelCanvas with a mock controller."""
    ...
    def test_overlay_rendering_state(self, pixel_canvas):
    ...
    def test_paint_event_logic(self, pixel_canvas, qtbot):
