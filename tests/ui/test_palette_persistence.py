...
def test_palette_path_saved_on_load(
    qtbot, app_context: AppContext, red_palette_json: Path
) -> None:
...
def test_palette_auto_loaded_on_init(
    qtbot, app_context: AppContext, red_palette_json: Path
) -> None:
...
def test_workspace_syncs_palette_on_set_controller(
    qtbot, app_context: AppContext, red_palette_json: Path
) -> None:
