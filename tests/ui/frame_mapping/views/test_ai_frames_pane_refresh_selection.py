...
class TestRefreshPreservesSelection:
    ...
    def test_set_mapping_status_does_not_emit_selection(self, qtbot: QtBot, tmp_path: Path) -> None:
        ...
        pane.select_frame_by_id("frame_002.png")
...
class TestFilterClearsSelectionSignal:
    ...
    def test_no_signal_when_selection_preserved_after_filter(self, qtbot: QtBot, tmp_path: Path) -> None:
        ...
        pane.select_frame_by_id("frame_000.png")
        assert pane.get_selected_id() == "frame_000.png"
...
class TestEmitSignalParameter:
    ...
    def test_select_frame_with_emit_signal_true_emits(self, qtbot: QtBot, tmp_path: Path) -> None:
        ...
        pane.select_frame_by_id("frame_002.png", emit_signal=True)
