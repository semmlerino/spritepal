...
def custom_detector() -> EmptyRegionDetector:
    ...
    config = EmptyRegionConfig(
        entropy_threshold=0.5, zero_threshold=0.8, pattern_threshold=0.7, max_unique_bytes=3, region_size=64
    )
...
class TestEmptyRegionDetectorInit:
    ...
    def test_detector_init_with_custom_config(self) -> None:
        ...
        config = EmptyRegionConfig(
            entropy_threshold=0.2, zero_threshold=0.95, pattern_threshold=0.9, max_unique_bytes=2, region_size=8192
        )
    ...
    def test_config_values_stored_correctly(self) -> None:
        ...
        config = EmptyRegionConfig(
            entropy_threshold=0.15, zero_threshold=0.85, pattern_threshold=0.75, max_unique_bytes=5, region_size=2048
        )
        detector = EmptyRegionDetector(config)
...
class TestPatternDetection:
    ...
    def test_pattern_4byte_repeat_high_coverage(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_pattern_no_patterns_detected(self, detector: EmptyRegionDetector) -> None:
...
class TestAnalyzeRegionDecision:
    ...
    def test_analyze_low_entropy_triggers_empty(self, custom_detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_low_entropy_boundary(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_high_zeros_triggers_empty(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_high_zeros_exactly_90_percent(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_high_zeros_91_percent(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_few_unique_bytes_triggers_empty(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_unique_bytes_boundary(self, detector: EmptyRegionDetector) -> None:
        """Exactly 4 unique bytes triggers empty (<= 4)."""
        data = b"\x00\x01\x02\x03" * 25  # 4 unique bytes
        result = detector.analyze_region(data, offset=0)
        assert result.is_empty is True

    def test_analyze_unique_bytes_just_above(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_pattern_score_triggers_empty(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_first_criterion_met_stops(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_no_criteria_met(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_region_with_offset(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_analyze_region_offset_zero(self, detector: EmptyRegionDetector) -> None:
...
class TestCaching:
    ...
    def test_cache_key_uses_offset_and_size(self, detector: EmptyRegionDetector) -> None:
...
class TestScanROMRegions:
    ...
    def test_scan_rom_empty_data(self, small_region_detector: EmptyRegionDetector) -> None:
        """Scanning empty ROM returns empty list."""
        result = small_region_detector.scan_rom_regions(b"")
        assert result == []

    def test_scan_rom_single_region_empty(self, small_region_detector: EmptyRegionDetector) -> None:
        """Single empty region returns empty list."""
        # All zeros = empty region
        result = small_region_detector.scan_rom_regions(b"\x00" * 16)
        assert result == []

    def test_scan_rom_single_region_nonempty(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_alternating_regions(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_uneven_size(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_exact_multiple(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_final_region_nonempty(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_final_region_empty(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_no_progress_callback(self, small_region_detector: EmptyRegionDetector) -> None:
        """Scan without callback works normally."""
        data = bytes(range(64))
        result = small_region_detector.scan_rom_regions(data, progress_callback=None)
        assert result is not None

    def test_scan_rom_progress_callback_called(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_progress_callback_arguments(self, detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_result_ordered(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_scan_rom_result_no_overlap(self, small_region_detector: EmptyRegionDetector) -> None:
...
class TestOptimizedScanRanges:
    ...
    def test_optimized_ranges_empty_rom(self, small_region_detector: EmptyRegionDetector) -> None:
        """All empty ROM returns empty list."""
        data = b"\x00" * 64
        result = small_region_detector.get_optimized_scan_ranges(data)
        assert result == []

    def test_optimized_ranges_single_region(self, small_region_detector: EmptyRegionDetector) -> None:
        """Single non-empty region returns single range."""
        data = bytes(range(16))
        result = small_region_detector.get_optimized_scan_ranges(data)
        assert result == [(0, 16)]

    def test_optimized_ranges_small_gap_merged(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_optimized_ranges_large_gap_separate(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_optimized_ranges_exact_min_gap_threshold(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_optimized_ranges_one_less_than_threshold(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_optimized_ranges_merge_three_regions(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_optimized_ranges_custom_min_gap_zero(self, small_region_detector: EmptyRegionDetector) -> None:
    ...
    def test_optimized_ranges_custom_min_gap_large(self, small_region_detector: EmptyRegionDetector) -> None:
        ...
        result = small_region_detector.get_optimized_scan_ranges(data, min_gap_size=1000000)

        assert len(result) == 1

    def test_optimized_ranges_result_ordering(self, small_region_detector: EmptyRegionDetector) -> None:
...
class TestEmptyRegionConfig:
    ...
    def test_config_custom_values(self) -> None:
        ...
        config = EmptyRegionConfig(
            entropy_threshold=0.2, zero_threshold=0.95, pattern_threshold=0.9, max_unique_bytes=8, region_size=8192
        )
