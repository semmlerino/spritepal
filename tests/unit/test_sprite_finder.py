...
class TestSpriteFinderWithRealComponents:
    ...
    def test_rom_with_sprites(self, tmp_path):
        ...
        Returns dict format matching tests/integration/conftest.py convention:
        - path: Path to ROM file
        - sprites: List of sprite metadata (empty for synthetic)
        - is_synthetic: True (always for unit tests)
        """
        ...
        return {
            "path": rom_path,
            "sprites": [],  # Synthetic data has no valid HAL sprites
            "is_synthetic": True,
        }
    ...
    def test_find_sprites_behavior_with_test_doubles(self, test_rom_with_sprites, output_dir):
        ...
        rom_path = str(test_rom_with_sprites["path"])
...
# =============================================================================
# Real HAL Tests (from tests/integration/test_integration_sprite_finder.py)
# =============================================================================
