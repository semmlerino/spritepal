    ...
    def test_workflow_state_machine(self):
        ...
        class WorkflowStateMachine:
            ...
            def is_valid_workflow(self):
                ...
                return "fullscreen_view" in self.state_history or "sprite_extraction" in self.state_history
            ...
            def submit_operation(self, operation_type, duration=1.0):
                with self.lock:
                    ...
                    if len(self.active_operations) < self.max_concurrent:
                        ...
                        # Queue for later
                        self.operation_queue.append({"id": operation_id, "type": operation_type, "duration": duration})
                        return None  # Queued
