...
class TestManagerIntegrationTDD:
    ...
    def test_session_manager_integration_tdd(self, test_data_repo, app_context):
    ...
    def test_error_propagation_between_managers_tdd(self, test_data_repo, app_context):
    ...
    def test_concurrent_manager_operations_tdd(self, test_data_repo, app_context):
    ...
    def test_resource_sharing_between_managers_tdd(self, test_data_repo, app_context):
...
class TestManagerLifecycleIntegrationTDD:
    ...
    def test_manager_initialization_order_tdd(self, app_context):
        ...
        """
        # With app_context, all managers are already initialized
        extraction_mgr = app_context.core_operations_manager
        injection_mgr = app_context.core_operations_manager
        session_mgr = app_context.application_state_manager
    ...
    def test_manager_cleanup_coordination_tdd(self, app_context):
        ...
        # Cleanup happens automatically via app_context fixture teardown
