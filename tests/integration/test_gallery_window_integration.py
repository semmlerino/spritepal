...
# NOTE: Pure mock-based logic tests (TestGalleryWindowHeadlessIntegration) have been
# moved to tests/unit/ui/windows/test_gallery_window_logic.py for clarity.
# Those tests don't require Qt or real components and belong in the unit test tier.
